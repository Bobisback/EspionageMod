...
class GalaxyTab : Tab {
	...
	void _GalaxyTab() {
		...
		@actionBar = ActionBar(this, vec2i(-6, -10));
	...
	void pinObject(Object@ obj, bool floating = false) {
	...
	void tick(double time) {
		...
		if(popupTimer != -1.0) {
			...
			else if(pressedObject !is null && mousePos.distanceTo(pressStart) > 4.0) {
