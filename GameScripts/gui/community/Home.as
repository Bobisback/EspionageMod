...
class CommunityHome : Tab {
	...
	CommunityHome() {
		...
		@designBG = GuiBackgroundPanel(this, Alignment(Left+30, Top+35, Left+35+600+48, Bottom-80));
		...
		@uploadButton = GuiButton(this, Alignment(Left+35+600+48-200, Bottom-72, Width=200, Height=52), locale::UPLOAD_DESIGN);
		uploadButton.font = FT_Bold;
		uploadButton.setIcon(icons::Export);

		@recentDesigns = GuiButton(this, Alignment(Left+30+600+48-424, Bottom-75, Width=200, Height=30), locale::RECENT_DESIGNS);

		@topratedDesigns = GuiButton(this, Alignment(Left+30+600+48-424, Bottom-75+32, Width=200, Height=30), locale::TOPRATED_DESIGNS);

		@searchDesigns = GuiTextbox(this, Alignment(Left+30, Bottom-69, Width=200, Height=46));
		searchDesigns.emptyText = locale::SEARCH_DESIGNS_PROMPT;

		@wikiBG = GuiBackgroundPanel(this, Alignment(Left+30+600+48+30, Top+30, Right-30, Bottom-30));
