...
class StatusFile : FileDef {
	array<string> visibilities = {"Everybody", "Owner", "Origin Empire", "Owner and Origin Empire", "Nobody"};
...
class ArtifactFile : FileDef {
	ArtifactFile() {
		...
		block("Artifact", doc="A type of artifact that can be found and used.").checkDuplicates(artifactCompletions);
			...
			field("Model", AT_Model, "Debris", doc="Model for the artifact.");
			field("Material", AT_Material, "Asteroid", doc="Model material for the artifact.");
...
class ResearchFile : FileDef {
	ResearchFile() {
		...
		block("Technology", doc="A type of technology that can be placed on the research grid.",
			...
			field("Point Cost", AT_Decimal, "0", doc="The amount of research points this technology costs to research.");
			field("Time Cost", AT_Decimal, "0", doc="The time in seconds this technology takes to research.");
...
class ResourceFile : FileDef {
	...
	ResourceFile() {
		...
		block("Resource", doc="A type of resource that can be found in the galaxy.",
			...
			field("Description", AT_Locale, "", doc="Description of the resource.");
...
class CreepFile : FileDef {
	CreepFile() {
		...
		auto@ pickup = camp.block("Pickup", doc="A possible type of pickup reward to be spawned with this camp.",
			...
			pickup.field("Material", AT_Material, "ResearchStation", doc="Model material for the pickup.");
...
class TraitFile : FileDef {
	TraitFile() {
		...
		block("Trait", doc="A trait that can be taken at game start.",
			...
			field("Availabe", AT_Boolean, "True", doc="Whether this trait is available to be chosen at all.");
...
class EffectorFile : FileDef {
	...
	array<string> physicalTypes = {"Instant", "Projectile", "Missile", "Beam"};
	...
	array<string> gfxTypes = {"Sprite", "Line"};
	void gfx(BlockDef@ b) {
