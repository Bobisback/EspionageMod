...
class LeaderAI : Component_LeaderAI, Savable {
	...
	void addAbilityOrder(Object& obj, int abilityId, vec3d target, double range, bool append) {
		addOrder(obj, AbilityOrder(abilityId, target, range), append);
		obj.wake();
	}

	void addAbilityOrder(Object& obj, int abilityId, Object@ target, double range, bool append) {
		addOrder(obj, AbilityOrder(abilityId, target, range), append);
		obj.wake();
	}
