...
class Ability : Serializable, Savable {
	int id = -1;
...
void parseLine(string& line, AbilityType@ type) {
	//Hook line
	auto@ hook = cast<IAbilityHook>(parseHook(line, "ability_effects::", instantiate=false));
	if(hook !is null)
