...
class GenericRepeatHook : EmpireEffect {
...
class Repeat : GenericRepeatHook {
...
class RepeatEmpireAttribute : GenericRepeatHook {
...
class RepeatPlanetLevel : GenericRepeatHook {
...
class RepeatExtended : GenericRepeatHook {
	Document doc("Repeat a hook an amount of times as stored in an empire attribute of the owner.");
	Argument hookID("Hook", AT_Hook, "planet_effects::GenericEffect");
...
class RepeatPopulationCoverage : GenericRepeatHook {
