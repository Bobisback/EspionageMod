...
void parseLine(string& line, ConstructionType@ type) {
	//Hook line
	auto@ hook = cast<IConstructionHook>(parseHook(line, "construction_effects::", instantiate=false));
	if(hook !is null)
