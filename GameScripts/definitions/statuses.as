...
class Status : Serializable, Savable {
...
void parseLine(string& line, StatusType@ type) {
	auto@ hook = cast<IStatusHook>(parseHook(line, "status_effects::", instantiate=false));
	if(hook !is null)
